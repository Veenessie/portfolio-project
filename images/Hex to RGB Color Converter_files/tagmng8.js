"use strict";if(typeof deskAdsNum==='undefined')
var deskAdsNum=2;if(typeof mobileAdsNum==='undefined')
var mobileAdsNum=2;if(typeof rtads==='undefined')
...
function setAds()
{if(deskAdsNum==0){document.getElementById("adngin-right_sidebar-0").style.display="none";return;}
if(mobileAdsNum==0&&window.innerWidth<980)
return;if(rtads==undefined)
